...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "OUuAwpt9iOVXnDAcwIoC";
	private final static String CLIENT_SECRET = "epqCf_g9Ek";
	private final static String REDIRECT_URI = "http://localhost:8080/coward/callback";
