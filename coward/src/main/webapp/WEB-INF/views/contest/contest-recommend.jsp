...
<body>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="banner-top-wrapper">
						<div class="banner-info">
							...
							<p class="sub-title sm-hidden">다음 몇가지 질문들을 답변해주시면, 저희가 알맞은
								공모전을 추천해드릴게요!</p>
                ...
                >-->
						...
						<div class="banner-image">
							<img src="${contextPath}/resources/assets/images/dart.svg"
								aria-hidden />
						</div>
					</div>
				</div>
	...
	<div class="recommend">
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<form action="contestRecommend" method="POST" name="recommendForm">
						<!-- typeNo의 값을 넣을 input hidden -->
					...
					<div class="recommend-step-1" id="recommend-step-1">
						...
						<div class="recommend-card-wrapper">
							...
							<div class="recommend-card" id="mobileCard" value="1"
								onclick='mobileClick()'>
							...
							<div class="recommend-card" id="webCard" value="2"
								onclick='webClick()'>
								<div class="recommend-card-img">
							...
							<div class="recommend-card" id="gameCard" value="3"
								onclick='gameClick()'>
								<div class="recommend-card-img">
							...
							<div class="recommend-card" id="securityCard" value="4"
							...
							<div class="recommend-skill-wrapper">
								<div class="recommend-skill">
									<div class="recommend-skill-img">
										<img
											src="${contextPath}/resources/assets/images/javaScript.svg" />
									</div>
									<h5>JavaScript</h5>
								</div>
								<div class="recommend-skill">
					...
					<div class="recommend-step-3" id="recommend-step-3">
						...
						<div class="recommend-reward-wrapper">
							<p>
								상금: <span id="value"></span>300만원 이상
							</p>
                ...
                -->
							...
							<input type="range" class="recommend-reward-slide"
								id="recommend-reward-slide" min="1" max="1000" value="10" />
						</div>
					</div>
