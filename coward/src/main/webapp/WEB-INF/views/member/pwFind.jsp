                ...
                <div class="col-sm-4">
                  <div class="profile-wrapper">
                    ...
                    <div class="title md-hidden">
                      <span class="secession">비밀번호 변경</span>
                      <hr class="line" />
                    </div>
                    <div class="secession-wrapper">
                      <div class="secession-box">
                        <div class="current-pw-box">
                          ...
                          <button class="pw-change-btn">다음</button>
                        </div>
                        <div class="change-pw-box">
                          <span class="pw-input-title">변경할 비밀번호</span>
                          <div class="input-bundle">
                            <input
                              class="pw-input"
                              id="changePw"
                              type="password"
                              placeholder="변경할 입력해주세요!"
                            />
                            <i class="ic-eye-close"></i>
                          </div>
                          <span class="pw-input-title"
                            >변경할 비밀번호 확인</span
                          >
                          <div class="input-bundle">
                            <input
                              ...
                              id="changePwChk"
                              type="password"
                              placeholder="힌번 더 입력해주세요!"
                            />
                            <i class="ic-eye-close"></i>
                          </div>
                          <button class="next-btn">변경하기</button>
                        </div>
                      </div>
                    </div>
