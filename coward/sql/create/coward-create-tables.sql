...
CREATE TABLE "CONTEST" (
	...
	"MEMBER_NO" NUMBER CONSTRAINT "FK_MEMBER_TO_CONTEST" REFERENCES "MEMBER" ("MEMBER_NO") NOT NULL,
	"CONTEST_TITLE"	VARCHAR2(100)		NOT NULL,
	"TYPE_NO"	NUMBER	 CONSTRAINT "FK_DEV_TYPE_TO_CONTEST" REFERENCES "DEV_TYPE" ("TYPE_NO")	NOT NULL,
	...
	"AD_NO"	NUMBER	CONSTRAINT "FK_AD_TO_CONTEST" REFERENCES "AD" ("AD_NO")	NOT NULL,
...
CREATE TABLE "CONTEST_ATTEND" (
	...
	"MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_CONTEST_ATTEND" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
	"CONTEST_NO"	NUMBER	CONSTRAINT "FK_CONTEST_TO_CONTEST_ATTEND" REFERENCES "CONTEST" ("CONTEST_NO")	NOT NULL,
	"DESCRIPTION"	VARCHAR2(1000)		NULL,
	"GITHUB"	VARCHAR2(200)		NOT NULL,
	"ATTEND_IMG"	VARCHAR2(1000)		NULL
);
...
CREATE TABLE "CHAT_ROOM" (
	...
	"MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_CHAT_ROOM" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
...
CREATE TABLE "CHAT_MESSAGE" (
	...
	"MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_CHAT_MESSAGE" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
...
CREATE TABLE "LIKE_USER" (
	...
	"C_MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_LIKE_USER_C" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
	"P_MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_LIKE_USER_P" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL
);
...
CREATE TABLE "LIKE_CON" (
	...
	"MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_LIKE_CON" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
	"CONTEST_NO"	NUMBER	CONSTRAINT "FK_CONTEST_TO_LIKE_CON" REFERENCES "CONTEST" ("CONTEST_NO")	NOT NULL
);
...
CREATE TABLE "CERTIFICATION" (
	...
	"MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_CERTIFICATION" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
...
CREATE TABLE "EXCHANGE" (
	"MEMBER_NO"	NUMBER	CONSTRAINT "FK_MEMBER_TO_EXCHANGE" REFERENCES "MEMBER" ("MEMBER_NO")	NOT NULL,
	"BANK_NO"	NUMBER	CONSTRAINT "FK_BANK_TO_EXCHANGE" REFERENCES "BANK" ("BANK_NO")	NOT NULL,
